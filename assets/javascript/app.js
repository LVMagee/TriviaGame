...
var answerArray = [["300", "206", "275", "187"], ["femur, thigh bone","spine","tibia, shin bone","skull"], ["foot", "ribs", "spine", "hand"], ["pathologist","detective","forensic anthropologist","orthopaedic doctor"], ["175", "300", "206", "130"], ["wrist/hand","spine","skull","ankle/foot"], ["severity","location","complication","no difference"], ["sky diving","ultimate fighting","motorcycle jumping","stuntman"]];
var correctAnswers = ["B. 206", "A. femur, thigh bone", "D. hand", "C. forensic anthropologist", "B. 300", "A. wrist/hand", "D. no difference", "C. motorcycle jumping"];
...
function generateWin() {
	correct++;
	gameHTML = "<p class='text-center timer-p'>Time Remaining: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>Correct! The answer is: " + correctAnswers[questionCounter] + "</p>" + "<img class='center-block img-wrong' src='assets/images/happy.png'>";
	$(".content").html(gameHTML);
	setTimeout(wait, 2 * 1000);  
}
